...
validate_recipe_outputs "importlib_resources-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="importlib_resources-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi